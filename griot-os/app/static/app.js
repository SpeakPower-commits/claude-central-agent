...
async function ask() {
  ...
  try {
    ...
    addBubble(data.answer, 'agent', `GRIOT · ${meta}`);
  } catch (err) {
...
addBubble('I’m ready. Pick a project and tell me what you are trying to achieve, decide, diagnose, build or improve.', 'agent', 'GRIOT');
